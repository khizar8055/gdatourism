...
abstract class $QuickActionModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String title, String iconKey, String route});
}
...
class _$QuickActionModelImpl implements _QuickActionModel {
  ...
  @override
  String toString() {
    return 'QuickActionModel(id: $id, title: $title, iconKey: $iconKey, route: $route)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, iconKey, route);
